...
| # | Arquivo | O que é |
|---|---|---|
| 1 | [`00-ENTREGA-BACKEND.md`](00-ENTREGA-BACKEND.md) | **este arquivo** — índice, lista das 53 rotas, regras que não se negociam |
| 2 | [`pedidos-backend.md`](pedidos-backend.md) | **ordem de serviço**: o que implementar, em que ordem (L0→L7), e o critério de aceite de cada lote |
| 3 | [`endpoints-backend.md`](endpoints-backend.md) | **contrato**: request e response de cada uma das 53 operações, envelope, códigos de erro |
| 4 | [`001_v1_completo.sql`](001_v1_completo.sql) | **schema**: 12 tabelas novas + ajustes. Idempotente, roda direto no SQL Editor do Supabase |
| 5 | [`002_seed_teste.sql`](002_seed_teste.sql) | dados de teste. **Só dev/homolog** |

Esta pasta é autocontida: os cinco arquivos acima são tudo que deve ser entregue
ao time de backend.
